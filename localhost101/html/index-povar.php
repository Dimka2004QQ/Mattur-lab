...
<html lang="ru">
 ...
 <body>
		...
		<div class="logo1">
				<div class="logo11">
				<div class="logo2">
					<img src="img/fotor_2023-5-17_18_7_28.png" width="50" height="50">
				</div>
				<p>Повар</p><br><br>
	...
	height: 50px;"><a href="#"></a>Выйти</button>
			<div class="nav-scroll">
				<nav class="nav-scroll_items">
					...
					<a class="nav-scroll_item" href="#" onclick='linkcontent("povar-first.html");'>Главная</a>
					<a class="nav-scroll_item" href="#" onclick='linkcontent("povar-good.html");'>Готовность</a>
					<a class="nav-scroll_item" href="#" onclick="linkcontent('povar-zacazs.html');">Заказы </a>
					<!--Конец ссылок-->
				</nav>
			</div>
		</header>
		<center><div class="content" id="content">
		<h3>Здравствуйте, уважаемый повар!!!</h3>
		<p><img src="img/povar-first.jpg" width="300" height="150" class="leftimg"></p>
		<div class="text1" >
		<b><p>Обязанности повара<br></b></br>


&#160; &#8226; Чистка картофеля;<br><br>
&#160; &#8226; Разморозка мяса;<br><br>
&#160; &#8226; Соблюдение чистоты на кухне;<br><br>
&#160; &#8226; Распределением обязанностей между коллегами;<br><br>
&#160; &#8226; Несет ответственность за работу на кухне;<br><br>
&#160; &#8226; Обеспечивает пожарную безопасность;<br><br>
&#160; &#8226; Отслеживает работоспособность подчиненных;<br><br>
&#160; &#8226; Готовка перечня блюд из заказа;<br><br>
